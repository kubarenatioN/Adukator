...
import { Training, TrainingProfileTraining } from 'src/app/typings/training.types';
...
export class TrainingPersonalizationComponent extends CenteredContainerDirective implements OnInit {
